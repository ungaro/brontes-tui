...
fn draw_logs(widget: &LiveStreamTab, area: Rect, buf: &mut Buffer, selected_row: usize) {
...
fn draw_events(widget: &LiveStreamTab, area: Rect, buf: &mut Buffer, selected_row: usize) {
...
fn draw_leaderboard(widget: &LiveStreamTab, area: Rect, buf: &mut Buffer) {
    let barchart = BarChart::default()
