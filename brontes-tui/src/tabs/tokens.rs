...
fn draw_livestream(widget: &mut TokensTab, area: Rect, buf: &mut Buffer) {
...
fn draw_logs(widget: &TokensTab, area: Rect, buf: &mut Buffer, selected_row: usize) {
...
fn draw_events(widget: &TokensTab, area: Rect, buf: &mut Buffer, selected_row: usize) {
...
fn draw_charts(widget: &TokensTab, area: Rect, buf: &mut Buffer) {
...
fn draw_leaderboard(widget: &TokensTab, area: Rect, buf: &mut Buffer) {
    let barchart = BarChart::default()
